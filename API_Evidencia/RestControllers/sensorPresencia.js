...
/**
  * Endpoint #1. getLogPresence
  * 
  * Este método realiza un select de todos los registros ubicados en
  * una tabla llamada "sensor_Presence".
  * 
  * Resultado: Obtendrá todos los registros de la tabla "sensor_Presence" 
  ...
  * Dashboards.
  */
async function getLogPresence(req,res){
  try{

    var sql = constants.selectPresence;
...
/**
  ...
  * Dashboards.
  */
async function getLogByDateBetweenPresence(req,res){
  try{
    var sql = constants.selectPresenceByDate;
...
/**
  ...
  *  
  */
async function insertLogPresence(req,res){
  try{

    var sql = constants.insertPresence;
